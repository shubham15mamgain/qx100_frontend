  ...
  return (
    <div>
      ...
      <div className="bg-[#DBEAFE] min-h-screen p-4">
        ...
        <div>
          <h1 className="text-center mb-8 text-black text-3xl font-bold">
            Task Subsidy
          </h1>
          {tasks.map((task) => (
            <div key={task.id}>
              <div
                className="text-center text-xl bg-blue-200 rounded-md  p-4 font-bold mb-4"
                style={{
              ...
              >
                ...
                <div className="flex justify-between text-sm text-blue-900 mb-4">
                  ...
                  <span>
                    {task.card.progress.currency}
                    {task.card.progress.amount}
                  </span>
